...
from keep_alive import keep_alive  # Убери, если не Replit
import asyncio
...
async def finish_order(message: types.Message, state: FSMContext):
    ...
    # Отправка запроса на отзыв через 1 час
...
# Обработка inline-кнопок подтверждения/отмены
...
if __name__ == '__main__':
    keep_alive()  # Удали, если не на Replit
